        ...
        <div className="">
          <div className="m-8 ml-[50px]  p-auto">
            ...
            <form action="" className="mt-3 flex">
              ...
              <Link
                to="/Pendonor"
                className="flex bg-blue-700 -tambahartikel rounded-md ml-[180px] w-[180px] h-10 font-semibold text-white p-[8px] hover:bg-donor"
              >
                <img
                  src={plush}
                  alt="plush"
            ...
            <thead>
              <tr className="border border-solid border-l-0 bottom-0 ">
                <th class="text-md px-6 py-3 border-b bg-stone-100">Name</th>
                <th class="text-md px-6 py-3 border-b  bg-stone-100">Tipe GOl Darah</th>
                <th class="text-md px-6 py-3 border-b  bg-stone-100">Tanggal Pemesanan</th>
                <th class="text-md px-6 py-3 border-b bg-stone-100">Tanggal Penjemputan</th>
            ...
            <thead className=' '>
              <tr className="text-center">
                <td class="text-md px-6 py-3 border-b border-gray-300 pb-2 text">Kevin</td>
                <td class="text-md px-6 py-3 border-b border-gray-300 pb-2">O+</td>
                <td class="text-md px-6 py-1 border-b border-gray-300 pb-2">10 Februari 2024</td>
                <td class="text-md px-6 py-1 border-b border-gray-300 pb-2">10 Februari 2024</td>
                <td class="flex py-2 px-4 border-b ">
              <Link
                to="/ButuhDarah"
                className="flex text-center bg-green-600 -tambahartikel rounded-md ml-[140px] w-[140px] h-8 font-semibold text-white p-[5px] hover:bg-red-600"
              >
                <img
                  src={silang}
                  alt="ceklis"
                  className="m-[3px] right[3px]"
                />Selesai{" "}
              </Link>
              {/* <Link
                to="/ButuhDarah"
            ...
            <thead className=''>
              <tr className="text-center">
                <td class="text-md px-6 py-3 border-b">Kevin</td>
                <td class="text-md px-6 py-3 border-b">A+</td>
                <td class="text-md px-6 py-1 border-b">10 Februari 2024</td>
                <td class="text-md px-6 py-1 border-b">10 Februari 2024</td>
                <td class="flex py-2 px-4 border-b ">
              <Link
                to="/ButuhDarah"
            ...
            <thead className=''>
              <tr className="text-center">
                <td class="text-md px-6 py-3 border-b">Kevin</td>
                <td class="text-md px-6 py-3 border-b">C-</td>
                <td class="text-md px-6 py-1 border-b">10 Februari 2024</td>
                <td class="text-md px-6 py-1 border-b">10 Februari 2024</td>
                <td class="flex py-2 px-4 border-b ">
              <Link
            ...
            <thead className=''>
              <tr className="text-center">
                <td class="text-md px-6 py-3 border-b">Kevin</td>
                <td class="text-md px-6 py-3 border-b">B+</td>
                <td class="text-md px-6 py-1 border-b">10 Februari 2024</td>
                <td class="text-md px-6 py-1 border-b">10 Februari 2024</td>
                <td class="flex py-2 px-4 border-b ">
              {/* <Link
              ...
              <Link
                to="/ButuhDarah"
                className="flex text-center bg-red-600 -tambahartikel rounded-md ml-[140px] w-[140px] h-8 font-semibold text-white p-[5px] hover:bg-red-600"
              >
                <img
                  src={ceklis}
                  alt="ceklis"
            ...
            <tbody class="py-2 px-4 border-b">
            </tbody>
          </table>
            </div>
