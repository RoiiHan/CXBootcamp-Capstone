          ...
          <div className="m-8 ml-[50px]  p-auto">
            ...
            <thead className=' '>
              <tr className="">
                ...
                <th class="text-md px-6 py-1 border-b border-gray-300 pb-2">10 Februari 2024</th>
                <th class="py-2 px-4 border-b ">&#10004</th>
              </tr>
            </thead>
            ...
            <div className="grid grid-cols-3  gap-8 ">
              <div className="w-[300px] mt-[60px] bg-white rounded-xl shadow-lg ">
                ...
                <div className="">
                  ...
                  Dibutuhkan 5 kantong darah  golongan A, Lubeg sekitarnya
                  </h5>
                  <div className="flex">
                    <p className="text-[11px] p-2 pt-0 pb-3">
                      Oleh <span className="font-semibold">Fadel M</span>
                    </p>
                    <p className="text-[11px] pl-[95px]">Hub: 081268953450</p>
                  </div>
                </div>
              </div>
              <div className="w-[300px]  mt-[60px] bg-white rounded-xl shadow-lg">
                ...
                <div className="">
                  ...
                  <div className="flex">
                    <p className="text-[11px] p-2 pt-0 pb-3">
                      Oleh <span className="font-semibold">Kevin</span>
                    </p>
                    <p className="text-[11px] pl-[95px]">Hub: 081268953450</p>
                  </div>
                </div>
...
export default DaftarPostingan