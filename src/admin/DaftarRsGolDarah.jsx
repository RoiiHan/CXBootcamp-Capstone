...
import rs from "../component/Rectangle 134.png";
import pencil from "../component/pencil-fill.png";
import smph from "../component/trash-fill.png";
import rs2 from "../component/Rectangle 4.png";

const DaftarRsGolDarah = () => {
          ...
          <div className="">
            <div className="">
              <div className="m-6 ml-8  p-auto h-[450px]">
                <span className="text-pdg font-bold text-[20px]">DAFTAR</span>{" "}
